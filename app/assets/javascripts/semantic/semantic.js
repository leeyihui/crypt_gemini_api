  ...
  $allModules
    .each(function(elementIndex) {
      ...
      module = {
            ...
            $item
              .each(function(){
                ...
                if(settings.match == 'both' || settings.match == 'text') {
                  ...
                  // Added by Lee Yi Hui - TriCeo Design
                  else if (settings.fullTextSearch === 'custom' && module.customSearch(searchTerm, text)) {
                    results.push(this);
                    return true;
                  }
        ...
        // Added by Lee Yi Hui - TriCeo Design
        customSearch: function (query, term) {
          query = query.toLowerCase();
          var input_array = [];
          input_array = query.match(/\S+/g) || [];
          term  = term.toLowerCase();
          var found = true;
          for(var i = 0; i < input_array.length; i++) {
            if(term.indexOf(input_array[i]) > -1) {
            } else {
              found = false;
            }
          }
